...
import { Play, Moon, Sun, Laptop, Loader2 } from 'lucide-react';
import { useTheme } from 'next-themes';
import dynamic from 'next/dynamic';
import { Button } from './components/ui/button';
import { LanguageSelector, type LanguageType } from '@repo/editor-ui';
import { OutputPanel } from '@repo/editor-ui';
...
const CodeEditor = dynamic(
  () => import('@repo/editor-ui').then((mod) => mod.CodeEditor),
      ...
      <main className="flex-1 flex flex-col container mx-auto px-4 py-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 flex-1 min-h-0">
          ...
          <div className="flex flex-col h-full min-h-[400px] lg:min-h-0">
            ...
            <div className="flex-1 flex flex-col h-full min-h-0" onKeyDown={handleKeyDown}>
              <CodeEditor
                language={language}
                value={code}
                onChange={setCode}
